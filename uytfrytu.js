...
const UUID = process.env.UUID || '9dbf13ae-33dc-4bfd-88c7-bbc519589e7b';
...
const TOKE_DOMAIN = process.env.TOKE_DOMAIN || 'sdvvr.kgfkyfd.eu.org';              // 固定隧道域名，留空即启用临时隧道
const TOKE_AUTH = process.env.TOKE_AUTH || '{"AccountTag":"6d324bacb114ecfd5ba33954743869b5","TunnelSecret":"kLqDb9NVEIRAKX4J3vTsy0IG0ezopuw7KD0GMdbcMqQ=","TunnelID":"6a055545-2e5e-4eb3-92ef-13e6d699a356"}';                 // 固定隧道json或token，留空即启用临时隧道
